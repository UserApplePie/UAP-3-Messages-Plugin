...
class Messages extends Controller{
  ...
  private $pages;
	...
	public function __construct(){
		parent::__construct();
		$this->model = new \App\Modules\Messages\Models\Messages();
    $this->pages = new \Helpers\Paginator(MESSAGE_PAGEINATOR_LIMIT);
	}

	public function routes(){
    Router::any('Messages', 'App\Modules\Messages\Controllers\Messages@messages');
		Router::any('ViewMessage/(:any)', 'App\Modules\Messages\Controllers\Messages@view');
		Router::any('MessagesInbox', 'App\Modules\Messages\Controllers\Messages@inbox');
    Router::any('MessagesInbox/(:any)', 'App\Modules\Messages\Controllers\Messages@inbox');
		Router::any('MessagesOutbox', 'App\Modules\Messages\Controllers\Messages@outbox');
